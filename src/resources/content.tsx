...
const home: Home = {
  ...
  label: "Home",
  title: `ArvinoDorito's Portfolio`,
    ...
    experiences: [
      {
        ...
        images: [
          ...
          {
            src: "/images/projects/projects-01/Image-01.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
          {
            src: "/images/projects/projects-01/Image-02.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
                    {
            src: "/images/projects/projects-01/Image-03.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
                    {
            src: "/images/projects/projects-01/Image-04.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
                    {
            src: "/images/projects/projects-01/Image-05.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
                    {
            src: "/images/projects/projects-01/Image-06.mp4",
            alt: "BTD Project",
            width: 16,
            height: 9,
          },
